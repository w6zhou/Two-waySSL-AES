#
#  Be sure to run `pod spec lint Two-waySSL-AES.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Wenqi Zhou"
  # s.authors            = { "Wenqi Zhou" => "zhou.wenqi@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/Wenqi Zhou"
